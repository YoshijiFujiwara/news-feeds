  ...
  .md-layout.md-alignment-center-center(style="height: 100vh!")
    md-card.md-layout-item.md-size-50(style="margin-top: 5em")
      ...
      form(@submit.prevent="validateForm")
        ...
        md-card-actions
          md-button(@click="$router.push('/login')") ログインへ
          md-button.md-primary.md-raised(:diabled="loading" type="submit") 登録
      md-snackbar(:md-active.sync="isAuthenticated") {{ form.email }} は登録されました！
    // ホーム画面へ
